tempApp.controller('ctr_productGoodsDetail', function($scope,http,$stateParams,$state,EzConfirm,messageFactory) {
	...
	$scope.goEdit = function(){
		...
		$state.go("index.product.productGoodsAdd",{"pm_id":$scope.pm_id});
	}
