tempApp.controller('ctr_goodsAdd', function($scope, http, messageFactory, $state, $stateParams, EzConfirm,dateUtil) {
  $scope.pager = { page: 1, rows: "10", sort: "pm_id", order: "desc", pageList: ["10", "20", "30"] };
  $scope.unitVO = {};
  $scope.skuList = [{ps_code:"P"+dateUtil.getTs()}];
  $scope.vo = {"pm_payway":"",pm_paymethod:"",pm_rebate_ratio:"0.00",pm_delivery_type:"",pm_delivery_fee_type:1,pm_market_price:0,pm_price:0,pm_typeid:$stateParams.pt_id,'pm_state':1,"pm_isgroup":"N","pm_valid_day":1,"pm_group_price":1,"pm_group_peopler_num":2, "pm_def3":"0.00"};
