tempApp.controller('ctr_calendarList', function($scope,$rootScope,$state,$stateParams,http,messageFactory,Modules_Config) {
	...
	$scope.createFun = function(obj){
		...
		$state.go(obj.mt_index_name,{'mt_id':obj.mt_id})
	}
