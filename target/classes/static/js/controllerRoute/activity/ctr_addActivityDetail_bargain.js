tempApp.controller('ctr_addActivityDetail_bargain', function($scope,commonFactory) {
	...
	$scope.iFrameSrc = '/main-mobile.html#/bargainPreview';
    ...
    $scope.showPreview = function(idx){
    	commonFactory.setScopeToChild('iframeId','bargainPreview','showIdx',idx);
    }
