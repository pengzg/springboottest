tempApp.controller('ctr_exportOrder', function($scope, $rootScope, http, messageFactory, $state, $stateParams, EzConfirm,dateUtil,$rootScope) {

    $scope.pager = {page:1,rows:'20',sort:'om_order_time',order:'desc',pageList:['10','20','30'],shopid:$rootScope.USER.shopId, om_state:8};
    ...
    $scope.queryList = function(){
        ...
        var url = '/admin/order/orderExportControl/exportOrder.action';
    ...
    $scope.doExport = function(){
        var str = "shopid="+$scope.pager.shopid;
          ...
          str += "&om_state="+$scope.pager.om_state;
		var url = '/admin/order/orderExportControl/doExportOrder.action?'+str;
