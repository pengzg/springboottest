tempApp.controller('ctr_promotionGroup', ['$scope','dateUtil','messageFactory','http','$state','EzConfirm','activityFactory','$rootScope',
  ...
  $scope.pager = {page:1,rows:'20',sort:'ppm_addtime',order:'desc',pageList:['10','20','30'],ppm_shopid:$rootScope.USER.shopId};
	...
	$scope.goDetail = function(x,type) {
		...
		if (type ==1) {
			...
			url = $state.href("index.marketing.promotionGroupCopy",{"ppm_id":x.ppm_id});
		}
