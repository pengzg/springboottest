tempApp.controller('ctr_promotionApplyEdit', function($scope, $rootScope, $location,
    ...
    $scope.getDetail = function() {
		...
		var success = function(result){
			...
			$("#start_time").val($scope.vo.pa_startdate+"至"+$scope.vo.pa_enddate);
			$('#start_time').daterangepicker({startDate:$scope.vo.pa_startdate,endDate:$scope.vo.pa_enddate}, function(start, end, label) { // 格式化日期显示框
