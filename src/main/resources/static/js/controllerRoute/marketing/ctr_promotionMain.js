tempApp.controller('ctr_promotionMain', ['$scope','dateUtil','messageFactory','http','$state','EzConfirm','activityFactory',
function($scope,dateUtil,messageFactory,http,$state,EzConfirm,activityFactory) {
  $scope.pager = {page:1,rows:'12',sort:'ppm_addtime',order:'desc',pageList:['10','20','30']};
	...
	$scope.goDetail = function(x) {
		$state.go("index.marketing.promotionMainDetail",{"ppm_id":x.ppm_id});
	}
