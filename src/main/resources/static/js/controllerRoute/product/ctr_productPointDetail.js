tempApp.controller('ctr_productPointDetail', function($scope,http,$stateParams,$state,EzConfirm,messageFactory) {
	...
	$scope.goEdit = function(){
		...
		$state.go("index.product.productPointAdd",{"pm_id":$scope.pm_id});
	}
