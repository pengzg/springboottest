tempApp.controller('ctr_productRedDetail', function($scope,http,$stateParams,$state,EzConfirm,messageFactory) {
	...
	$scope.goEdit = function(){
		...
		$state.go("index.product.productRedAdd",{"pm_id":$scope.pm_id});
	}
