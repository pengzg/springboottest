tempApp.controller('ctr_productAdd', function($scope, http, messageFactory, $state, $stateParams, EzConfirm) {
	...
	if ($scope.pm_id) {
		...
		$scope.vo = {"pm_state":1,"pm_integral_mall":'N',"pm_typeid":'1001',"pm_market_price":1,"pm_payment_type":1,"pm_integral_value":0.1,"pm_stock":0};
	}
