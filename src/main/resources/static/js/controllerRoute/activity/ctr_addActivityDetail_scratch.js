tempApp.controller('ctr_addActivityDetail_scratch', function($scope,commonFactory) {
	...
	$scope.iFrameSrc = '/main-mobile.html#/scratchCardPreview';
    ...
    $scope.showPreview = function(idx){
    	commonFactory.setScopeToChild('iframeId','scratchCardPreview','showIdx',idx);
    }
