tempApp.controller('ctr_addActivityDetail_shake', function($scope,commonFactory,$timeout) {
	...
	$scope.iFrameSrc = '/main-mobile.html#/shakePreview';
	...
	$scope.navigate = ['游戏环节','活动说明','我的奖品','中奖','活动结束'];
    ...
    $scope.showPreview = function(idx){
    	commonFactory.setScopeToChild('iframeId','shakePreview','showIdx',idx);
    }
