tempApp.controller('ctr_addActivityDetail', function($scope,commonFactory) {
	...
	$scope.prizeType = ['奖项一','奖项二','奖项三'];
	$scope.defalut_back = '../../img/mobile/bg.png';
	$scope.defalut_banner = '../../img/mobile/banner.png';
	$scope.defalut_logo = '../../img/mobile/logo2.png';
	var PRIZETYPE = ['奖项一','奖项二','奖项三','奖项四','奖项五','奖项六','奖项七'];
	$scope.titleCheck = false;
	var ALL_NAVIGATE = ['游戏环节','领取环节','活动说明','我的奖品'];
	$scope.navigate = ['游戏环节','领取环节','活动说明','我的奖品','活动结束'];
	$scope.config = {
		base: {
				name: '口令红包', 	//活动名称
				time: '', 			//活动起止时间
	...
	//
	$scope.iFrameSrc = '/main-mobile.html#/wordenvelopePreview';
	var dateRangeConfig = {
    ...
    $scope.showPreview = function(idx){
    	commonFactory.setScopeToChild('iframeId','wordenvelopePreview','showIdx',idx);
    }
    ...
    $scope.setPreviewToChild = function(){
    	...
    	commonFactory.setScopeToChild('iframeId','wordenvelopePreview','data1',data1);
    }
